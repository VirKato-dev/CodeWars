...
public class MaxChainOfOnes {
    public static void main(String[] args) {
        System.out.println("4 == " + findMaxOnes(new int[]{1, 0, 1, 1, 1, 0, 0, 1, 1, 1}));
        System.out.println("6 == " + findMaxOnes(new int[]{1, 0, 0, 1, 1, 1, 0, 1, 1, 1}));
        System.out.println("5 == " + findMaxOnes(new int[]{0, 1, 0, 1, 1, 1, 0, 1, 1, 0}));
    }
